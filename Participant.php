...
$query_select_participants = "SELECT id_part, Nom_part, Prenom_part FROM participant";
$result_participants = mysqli_query($connect, $query_select_participants);
...
<body>
    <header class="header">
        <section class="flex">
            ...
            <nav class="navbar">
                ...
                <a href="Participant.php">Participant</a>
    ...
    <section>
    <h2 class="heading">Liste des participants</h2>
    <a href='ajouter_participant.php' class='add-icon'> <img src='images/plus.png'> Ajouter</a>
   <table class="accounts" border="2">
        <thead>
            <tr>
                <th>ID du participant</th>
                <th>Nom du participant</th>
                <th>Prénom du participant</th>
                <th>Modifier</th>
                <th>Supprimer</th>
            </tr>
        </thead>
        <tbody>
            <?php
            // Requête SQL pour récupérer les informations des participants
            ...
            if ($result !== false) {
                ...
                if ($result->num_rows > 0) {
                    while ($row = $result->fetch_assoc()) {
                        ...
                        echo "<td>" . $row["Prenom_part"] . "</td>";
                        echo "<td><a href='modifier_participant.php?id=" . $row['id_part'] . "'><img src='images/pen.png' alt='Modifier'>Modifier</a></td>";
                        echo "<td><a href='supprimer_participant.php?delete=" . $row['id_part'] . "'><img src='images/trash.png' alt='Supprimer'> Supprimer</a></td>";
                        echo "</tr>";
                    }
                } else {
